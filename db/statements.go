...
const (
	...
	getLast15Minutes = "SELECT * FROM records WHERE created  >= DATE_SUB(CURDATE(), INTERVAL 15 MINUTE);"

	getLastXMinutes = "SELECT * FROM records WHERE created  >= DATE_SUB(CURDATE(), INTERVAL 15 MINUTE);"
